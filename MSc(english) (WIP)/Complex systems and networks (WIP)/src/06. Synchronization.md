...
Parameterization in a monotonic way The Trajectory
...
However, it can be proven that the oscillator can **come infinitely close** to the same point. This is typical of chaotic attractors.


another way to find the parametrization which defines me a phase is to define the crossing of a suitably Poincaré section. 
