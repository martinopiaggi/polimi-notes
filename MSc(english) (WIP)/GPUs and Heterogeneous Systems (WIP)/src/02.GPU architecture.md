...
OpenGL/Direct3D workflow: – Application provides shader program binaries to the GPU – Application sets graphics pipeline parameters – Application provides to the GPU a buffer of vertices – Application send to the GPU a drawing command
