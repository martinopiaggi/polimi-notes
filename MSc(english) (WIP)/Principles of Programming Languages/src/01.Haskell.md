...
- **Functor**: A type class that defines a way to apply a function over a structure, preserving the structure's type. Note that in C++, [functors](../../Advanced%20OS%20(WIP)/src/07.Cpp.md##Functors) exist and are involving "mapping operations" but are a different thing. 
